...
class Email2nicknameTest(BaseTestCase):
    def test_profile_is_none(self):
        ...
        assert email2nickname(email2contact_email(self.user.username)) == self.user.username.split('@')[0]
    ...
    def test_nickname_contains_space(self):
        ...
        assert email2nickname(email2contact_email(self.user.username)) == 'foo bar'
